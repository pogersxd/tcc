...
function renderAddMusicForm()
{
  ...
  echo <<<HTML
    ...
    <form id="add-music-form" class="default-form" enctype="multipart/form-data">
        ...
        <label>Arquivo: (máximo de 10MB)<input type="file" name="arquivo" required>(recomenda-se o formato .opus para maior qualidade com menos tamanho de arquivo)</label><br>
